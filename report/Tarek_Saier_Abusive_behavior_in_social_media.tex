...
\caption{Annotation instructions given to Yahoo! employees for labeling comments in \cite{Yahoo:2016}.}
...
\paragraph{Labelling}
Trained employes and crowd sourcing experiments and eval data set extra effort.

- NLP features (e.g. \cite{Distributed:2014})\\
